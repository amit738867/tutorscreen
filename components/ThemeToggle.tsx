...
export function ThemeToggle() {
  ...
  return (
    <Button
      ...
      className="rounded-full size-10 border border-white/10 dark:border-white/5 bg-white/5 dark:bg-slate-900/50 hover:bg-emerald-500/10 transition-all duration-500"
    >
